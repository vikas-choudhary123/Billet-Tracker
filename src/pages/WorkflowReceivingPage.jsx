...
import PendingBillets from "../Lab-Pending"
import ReceivingHistory from "../Lab-History"
...
function WorkflowReceivingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-cyan-100 dark:from-slate-900 dark:to-slate-80">
      <Header />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2">
                <Card className="border-teal-200 dark:border-teal-800 shadow-lg">
                  <CardHeader className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white dark:from-teal-800 dark:to-cyan-800 rounded-t-lg">
                    <CardTitle>Billet Receiving Form</CardTitle>
                  ...
                  <form onSubmit={handleSubmit}>
                    <CardContent className="space-y-4 pt-6">
                      {!selectedBilletId ? (
                        <div className="text-center p-6 text-slate-500">
                          Please select a billet from the pending list to process receiving
                        </div>
                      ) : (
                    ...
                    <CardFooter className="flex justify-between">
                      <Button
                        type="button"
                        variant="outline"
                        onClick={() => setSelectedBilletId(null)}
                        className="border-teal-200 text-teal-600 hover:bg-teal-50 dark:border-teal-800 dark:text-teal-400 dark:hover:bg-teal-900/30"
                        disabled={!selectedBilletId}
                      >
                        Cancel
                      </Button>
                      <Button
                        type="submit"
                        disabled={isSubmitting || !selectedBilletId}
