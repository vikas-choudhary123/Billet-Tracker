...
import LabPending from "../Lab-Pending"
import LabHistory from "../Lab-History"
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from "../components/ui/dialog"

function WorkflowLabTesting() {
      ...
      <div className="container mx-auto py-6 px-4">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Test and analyze billet samples for quality control
            </p>
          </div>
          <Link to="/workflow">
            <Button
        ...
        <Tabs defaultValue="pending" className="mb-6" onValueChange={setActiveTab}>
          <TabsList className="grid w-full md:w-[400px] grid-cols-2">
            <TabsTrigger value="pending">Pending Tests ({pendingRecords.length})</TabsTrigger>
            <TabsTrigger value="history">Test History ({historyRecords.length})</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="history" className="mt-4">
            <LabHistory historyRecords={historyRecords} />
          </TabsContent>
        </Tabs>
        ...
        <Dialog open={formDialogOpen} onOpenChange={setFormDialogOpen}>
          <DialogContent className="sm:max-w-xl text-white">
            <DialogHeader>
              <DialogTitle>Lab Testing Form</DialogTitle>
              <DialogDescription>
                {selectedBilletId
                  ? `Enter testing details for billet ${selectedBilletId}`
                  : "Select a billet from the list to begin testing"}
              </DialogDescription>
            </DialogHeader>
...
export default WorkflowLabTesting